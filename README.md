...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/sprintboard.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/firstepic.png) 
As mentioned earlier the whole application was broken down into epics, once all epics are completed, the full application has been completed.
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/firststory.png)

Each story will be created from the list of stories in the corresponding epic.
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/tests.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/box.png)
...
Then I used an angular loop through iterate through each box in the board component and try to display them. To ensure this was being done via the input parameter, I also displayed the coordinate of the box:
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/boxes.png)


I then used some CSS classes to structure the boxes into a chess board
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/firstboard.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/firstboxcomponenthtml.png)

This HTML displays different icons depending on the values stored in box model by using "ngIf" which behaves as an if statement for HTML. If the box mode is empty the application won't display a piece inside the box, and it won't return an error.
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/htmlsimplified.png)
...
This is the box model (subject):
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/boxmodel.png)

This is the box component (obvserver):
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/boxcomponentobserver.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/algorithm.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/finalarchitecture.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/boxcomponent.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/registercoordinate.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/updateboards.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/sendcoordinates.png)

On the other hand, game component would listen to any changes and consume the value changed and run some logic:
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/subscribe.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/firstMVP.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/availablemovesservice.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/updateboardservice.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/kingmoves.png)

However, in chess there are more rules to the movement of the king. A king cannot move to a place it would be in check, it is an illegal move. Meaning that my program cannot let a player, even if it is a foolish move, move a king to a position in which it would get eaten/killed.
...
To do this, a new service was introduced, the helper service, designed with methods to fulfil with the DRY principle as they are used frequently throughout the application. 
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/helperservice.png)

This service has 3 functions:

A function to switch the colour from white to black and vice versa, mainly used to switch the colour when getting the enemy's moves (e.g. getOppositeColour(this.turn).
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/isvalidmove.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/angulartest.png)
After creating unit tests for each function, I caught a lot of logic errors on the functions. For example, isInArray always returned false as it was not comparing the objects correctly, this was fixed by comparing the attributes of the object rather than the object itself.
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/isinstalemate.png)
...
![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/gameovermodals.png)

This is the function that opens the modal:

![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/checkgameover.png)
...
This was also the main reason I needed to use observable solution mentioned for the box display, as angular's ngOnChanges (a feature that picks up on any change done on the model) was not working. This was because the changes were occurring through the methods so ngOnChanges couldn't pick this up.

![text](https://github.com/djaumandreuonda/AdaChess/blob/main/Pictures/finalboxmodel.png)
...
The menu could also allow players to save a game, a board model could be saved and then loaded by the board model to display a previously saved game instead of instantiating a new board. A UI would be created for this.
